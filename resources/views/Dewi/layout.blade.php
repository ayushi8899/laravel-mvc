...
<head>
  ...
  <link href="{{ asset('Dewi/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{ asset('Dewi/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{ asset('Dewi/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
  <link href="{{ asset('Dewi/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="{{ asset('Dewi/assets/css/style.css')}}" rel="stylesheet">
